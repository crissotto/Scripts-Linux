...
grant connect to "pmartinez";
grant connect to "edora";
grant connect to "rlukaku";
grant connect to "mdiaz";
grant connect to "erisas";
grant connect to "sfernandez";
grant connect to "pfuentes";
...
{ unload file name = usuar00102.unl number of rows = 25 }
...
grant select on "root".roles_usuario to "edora" as "root";
grant select on "root".roles_usuario to "erisas" as "root";
grant select on "root".roles_usuario to "mdiaz" as "root";
...
grant select on "root".roles_usuario to "pfuentes" as "root";
grant select on "root".roles_usuario to "pmartinez" as "root";
grant select on "root".roles_usuario to "rlukaku" as "root";
grant select on "root".roles_usuario to "sfernandez" as "root";
grant select on "root".roles_usuario to "transportista" as "root";
grant select on "root".estados_usuario to "administrador" as "root";
grant select on "root".estados_usuario to "edora" as "root";
grant select on "root".estados_usuario to "erisas" as "root";
grant select on "root".estados_usuario to "mdiaz" as "root";
grant select on "root".estados_usuario to "operario_puerto" as "root";
grant select on "root".estados_usuario to "rlukaku" as "root";
grant select on "root".estados_usuario to "sfernandez" as "root";
...
grant select on "root".usuarios to "edora" as "root";
grant update(estado_usuario) on "root".usuarios to "edora" as "root";
grant update(conectado) on "root".usuarios to "edora" as "root";
grant update(ultima_conexion) on "root".usuarios to "edora" as "root";
grant select on "root".usuarios to "erisas" as "root";
grant update(estado_usuario) on "root".usuarios to "erisas" as "root";
grant update(conectado) on "root".usuarios to "erisas" as "root";
grant update(ultima_conexion) on "root".usuarios to "erisas" as "root";
grant select on "root".usuarios to "mdiaz" as "root";
grant update(estado_usuario) on "root".usuarios to "mdiaz" as "root";
grant update(conectado) on "root".usuarios to "mdiaz" as "root";
grant update(ultima_conexion) on "root".usuarios to "mdiaz" as "root";
...
grant select on "root".usuarios to "pfuentes" as "root";
grant update(nombre) on "root".usuarios to "pfuentes" as "root";
grant update(apellido) on "root".usuarios to "pfuentes" as "root";
grant update(contrasena) on "root".usuarios to "pfuentes" as "root";
grant update(eliminado) on "root".usuarios to "pfuentes" as "root";
grant update(estado_usuario) on "root".usuarios to "pfuentes" as "root";
grant update(rol_usuario) on "root".usuarios to "pfuentes" as "root";
grant update(conectado) on "root".usuarios to "pfuentes" as "root";
grant update(ultima_conexion) on "root".usuarios to "pfuentes" as "root";
grant insert on "root".usuarios to "pfuentes" as "root";
grant delete on "root".usuarios to "pfuentes" as "root";
grant select on "root".usuarios to "pmartinez" as "root";
grant update(nombre) on "root".usuarios to "pmartinez" as "root";
grant update(apellido) on "root".usuarios to "pmartinez" as "root";
grant update(contrasena) on "root".usuarios to "pmartinez" as "root";
grant update(eliminado) on "root".usuarios to "pmartinez" as "root";
grant update(estado_usuario) on "root".usuarios to "pmartinez" as "root";
grant update(rol_usuario) on "root".usuarios to "pmartinez" as "root";
grant update(conectado) on "root".usuarios to "pmartinez" as "root";
grant update(ultima_conexion) on "root".usuarios to "pmartinez" as "root";
grant insert on "root".usuarios to "pmartinez" as "root";
grant delete on "root".usuarios to "pmartinez" as "root";
grant select on "root".usuarios to "rlukaku" as "root";
grant update(estado_usuario) on "root".usuarios to "rlukaku" as "root";
grant update(conectado) on "root".usuarios to "rlukaku" as "root";
grant update(ultima_conexion) on "root".usuarios to "rlukaku" as "root";
grant select on "root".usuarios to "sfernandez" as "root";
grant update(estado_usuario) on "root".usuarios to "sfernandez" as "root";
grant update(conectado) on "root".usuarios to "sfernandez" as "root";
grant update(ultima_conexion) on "root".usuarios to "sfernandez" as "root";
...
grant select on "root".estados_lote to "edora" as "root";
grant select on "root".estados_lote to "erisas" as "root";
grant select on "root".estados_lote to "operario_puerto" as "root";
grant select on "root".estados_lote to "pfuentes" as "root";
grant select on "root".estados_lote to "pmartinez" as "root";
grant select on "root".estados_lote to "rlukaku" as "root";
grant select on "root".estados_lote to "sfernandez" as "root";
...
grant select on "root".lotes to "edora" as "root";
grant update(asignado) on "root".lotes to "edora" as "root";
grant update(estado_lote) on "root".lotes to "edora" as "root";
grant select on "root".lotes to "erisas" as "root";
grant update(nombre_lote) on "root".lotes to "erisas" as "root";
grant update(tipo_vehiculos) on "root".lotes to "erisas" as "root";
grant update(cantidad_vehiculos) on "root".lotes to "erisas" as "root";
grant update(descripcion) on "root".lotes to "erisas" as "root";
grant update(estado_lote) on "root".lotes to "erisas" as "root";
grant update(eliminado) on "root".lotes to "erisas" as "root";
grant insert on "root".lotes to "erisas" as "root";
...
grant select on "root".lotes to "pfuentes" as "root";
grant update(nombre_lote) on "root".lotes to "pfuentes" as "root";
grant update(tipo_vehiculos) on "root".lotes to "pfuentes" as "root";
grant update(cantidad_vehiculos) on "root".lotes to "pfuentes" as "root";
grant update(descripcion) on "root".lotes to "pfuentes" as "root";
grant update(estado_lote) on "root".lotes to "pfuentes" as "root";
grant update(eliminado) on "root".lotes to "pfuentes" as "root";
grant insert on "root".lotes to "pfuentes" as "root";
grant select on "root".lotes to "pmartinez" as "root";
grant update(nombre_lote) on "root".lotes to "pmartinez" as "root";
grant update(tipo_vehiculos) on "root".lotes to "pmartinez" as "root";
grant update(cantidad_vehiculos) on "root".lotes to "pmartinez" as "root";
grant update(descripcion) on "root".lotes to "pmartinez" as "root";
grant update(estado_lote) on "root".lotes to "pmartinez" as "root";
grant update(eliminado) on "root".lotes to "pmartinez" as "root";
grant insert on "root".lotes to "pmartinez" as "root";
grant select on "root".lotes to "rlukaku" as "root";
grant update(nombre_lote) on "root".lotes to "rlukaku" as "root";
grant update(tipo_vehiculos) on "root".lotes to "rlukaku" as "root";
grant update(cantidad_vehiculos) on "root".lotes to "rlukaku" as "root";
grant update(descripcion) on "root".lotes to "rlukaku" as "root";
grant update(estado_lote) on "root".lotes to "rlukaku" as "root";
grant update(eliminado) on "root".lotes to "rlukaku" as "root";
grant insert on "root".lotes to "rlukaku" as "root";
grant select on "root".lotes to "sfernandez" as "root";
grant update(nombre_lote) on "root".lotes to "sfernandez" as "root";
grant update(tipo_vehiculos) on "root".lotes to "sfernandez" as "root";
grant update(cantidad_vehiculos) on "root".lotes to "sfernandez" as "root";
grant update(descripcion) on "root".lotes to "sfernandez" as "root";
grant update(estado_lote) on "root".lotes to "sfernandez" as "root";
grant update(eliminado) on "root".lotes to "sfernandez" as "root";
grant insert on "root".lotes to "sfernandez" as "root";
...
grant select on "root".estados_vehiculo to "edora" as "root";
grant select on "root".estados_vehiculo to "erisas" as "root";
grant select on "root".estados_vehiculo to "mdiaz" as "root";
...
grant select on "root".estados_vehiculo to "pfuentes" as "root";
grant select on "root".estados_vehiculo to "pmartinez" as "root";
grant select on "root".estados_vehiculo to "rlukaku" as "root";
grant select on "root".estados_vehiculo to "sfernandez" as "root";
...
grant select on "root".tipos_vehiculo to "edora" as "root";
grant select on "root".tipos_vehiculo to "mdiaz" as "root";
...
grant select on "root".tipos_vehiculo to "pfuentes" as "root";
grant select on "root".tipos_vehiculo to "pmartinez" as "root";
grant select on "root".tipos_vehiculo to "sfernandez" as "root";
...
grant select on "root".vehiculos to "edora" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "edora" as "root";
grant select on "root".vehiculos to "erisas" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "erisas" as "root";
grant update(codigo_qr) on "root".vehiculos to "erisas" as "root";
grant select on "root".vehiculos to "mdiaz" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "mdiaz" as "root";
grant update(baja) on "root".vehiculos to "mdiaz" as "root";
...
grant select on "root".vehiculos to "pfuentes" as "root";
grant update(marca) on "root".vehiculos to "pfuentes" as "root";
grant update(modelo) on "root".vehiculos to "pfuentes" as "root";
grant update(tipo_vehiculo) on "root".vehiculos to "pfuentes" as "root";
grant update(anualidad) on "root".vehiculos to "pfuentes" as "root";
grant update(color) on "root".vehiculos to "pfuentes" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "pfuentes" as "root";
grant update(codigo_qr) on "root".vehiculos to "pfuentes" as "root";
grant update(baja) on "root".vehiculos to "pfuentes" as "root";
grant update(eliminado) on "root".vehiculos to "pfuentes" as "root";
grant insert on "root".vehiculos to "pfuentes" as "root";
grant delete on "root".vehiculos to "pfuentes" as "root";
grant select on "root".vehiculos to "pmartinez" as "root";
grant update(marca) on "root".vehiculos to "pmartinez" as "root";
grant update(modelo) on "root".vehiculos to "pmartinez" as "root";
grant update(tipo_vehiculo) on "root".vehiculos to "pmartinez" as "root";
grant update(anualidad) on "root".vehiculos to "pmartinez" as "root";
grant update(color) on "root".vehiculos to "pmartinez" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "pmartinez" as "root";
grant update(codigo_qr) on "root".vehiculos to "pmartinez" as "root";
grant update(baja) on "root".vehiculos to "pmartinez" as "root";
grant update(eliminado) on "root".vehiculos to "pmartinez" as "root";
grant insert on "root".vehiculos to "pmartinez" as "root";
grant delete on "root".vehiculos to "pmartinez" as "root";
grant select on "root".vehiculos to "rlukaku" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "rlukaku" as "root";
grant update(codigo_qr) on "root".vehiculos to "rlukaku" as "root";
grant select on "root".vehiculos to "sfernandez" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "sfernandez" as "root";
grant update(codigo_qr) on "root".vehiculos to "sfernandez" as "root";
...
grant select on "root".tipos_ubicaciones to "mdiaz" as "root";
grant select on "root".tipos_ubicaciones to "operario_patio" as "root";
grant select on "root".tipos_ubicaciones to "pfuentes" as "root";
grant select on "root".tipos_ubicaciones to "pmartinez" as "root";
...
grant select on "root".ubicaciones to "mdiaz" as "root";
grant update(cantidad_vehiculos_actual) on "root".ubicaciones to "mdiaz" as "root";
...
grant select on "root".ubicaciones to "pfuentes" as "root";
grant update(nombre_ubicacion) on "root".ubicaciones to "pfuentes" as "root";
grant update(capacidad_maxima) on "root".ubicaciones to "pfuentes" as "root";
grant update(cantidad_vehiculos_actual) on "root".ubicaciones to "pfuentes" as "root";
grant update(tipo_ubicacion) on "root".ubicaciones to "pfuentes" as "root";
grant insert on "root".ubicaciones to "pfuentes" as "root";
grant delete on "root".ubicaciones to "pfuentes" as "root";
grant select on "root".ubicaciones to "pmartinez" as "root";
grant update(nombre_ubicacion) on "root".ubicaciones to "pmartinez" as "root";
grant update(capacidad_maxima) on "root".ubicaciones to "pmartinez" as "root";
grant update(cantidad_vehiculos_actual) on "root".ubicaciones to "pmartinez" as "root";
grant update(tipo_ubicacion) on "root".ubicaciones to "pmartinez" as "root";
grant insert on "root".ubicaciones to "pmartinez" as "root";
grant delete on "root".ubicaciones to "pmartinez" as "root";
...
grant select on "root".inspecciones to "erisas" as "root";
grant update(incidente_vehiculo) on "root".inspecciones to "erisas" as "root";
grant insert on "root".inspecciones to "erisas" as "root";
grant select on "root".inspecciones to "mdiaz" as "root";
grant update(incidente_vehiculo) on "root".inspecciones to "mdiaz" as "root";
grant insert on "root".inspecciones to "mdiaz" as "root";
...
grant select on "root".inspecciones to "pfuentes" as "root";
grant update(incidente_vehiculo) on "root".inspecciones to "pfuentes" as "root";
grant insert on "root".inspecciones to "pfuentes" as "root";
grant select on "root".inspecciones to "pmartinez" as "root";
grant update(incidente_vehiculo) on "root".inspecciones to "pmartinez" as "root";
grant insert on "root".inspecciones to "pmartinez" as "root";
grant select on "root".inspecciones to "rlukaku" as "root";
grant update(incidente_vehiculo) on "root".inspecciones to "rlukaku" as "root";
grant insert on "root".inspecciones to "rlukaku" as "root";
grant select on "root".inspecciones to "sfernandez" as "root";
grant update(incidente_vehiculo) on "root".inspecciones to "sfernandez" as "root";
grant insert on "root".inspecciones to "sfernandez" as "root";
...
grant select on "root".desperfectos_vehiculos to "erisas" as "root";
grant update(observacion) on "root".desperfectos_vehiculos to "erisas" as "root";
grant insert on "root".desperfectos_vehiculos to "erisas" as "root";
grant select on "root".desperfectos_vehiculos to "mdiaz" as "root";
grant update(observacion) on "root".desperfectos_vehiculos to "mdiaz" as "root";
grant insert on "root".desperfectos_vehiculos to "mdiaz" as "root";
...
grant select on "root".desperfectos_vehiculos to "pfuentes" as "root";
grant update(observacion) on "root".desperfectos_vehiculos to "pfuentes" as "root";
grant insert on "root".desperfectos_vehiculos to "pfuentes" as "root";
grant select on "root".desperfectos_vehiculos to "pmartinez" as "root";
grant update(observacion) on "root".desperfectos_vehiculos to "pmartinez" as "root";
grant insert on "root".desperfectos_vehiculos to "pmartinez" as "root";
grant select on "root".desperfectos_vehiculos to "rlukaku" as "root";
grant update(observacion) on "root".desperfectos_vehiculos to "rlukaku" as "root";
grant insert on "root".desperfectos_vehiculos to "rlukaku" as "root";
grant select on "root".desperfectos_vehiculos to "sfernandez" as "root";
grant update(observacion) on "root".desperfectos_vehiculos to "sfernandez" as "root";
grant insert on "root".desperfectos_vehiculos to "sfernandez" as "root";
...
grant select on "root".imagenes_desperfectos to "erisas" as "root";
grant update(ruta_imagen) on "root".imagenes_desperfectos to "erisas" as "root";
grant insert on "root".imagenes_desperfectos to "erisas" as "root";
grant select on "root".imagenes_desperfectos to "mdiaz" as "root";
grant update(ruta_imagen) on "root".imagenes_desperfectos to "mdiaz" as "root";
grant insert on "root".imagenes_desperfectos to "mdiaz" as "root";
...
grant select on "root".imagenes_desperfectos to "pfuentes" as "root";
grant update(ruta_imagen) on "root".imagenes_desperfectos to "pfuentes" as "root";
grant insert on "root".imagenes_desperfectos to "pfuentes" as "root";
grant select on "root".imagenes_desperfectos to "pmartinez" as "root";
grant update(ruta_imagen) on "root".imagenes_desperfectos to "pmartinez" as "root";
grant insert on "root".imagenes_desperfectos to "pmartinez" as "root";
grant select on "root".imagenes_desperfectos to "rlukaku" as "root";
grant update(ruta_imagen) on "root".imagenes_desperfectos to "rlukaku" as "root";
grant insert on "root".imagenes_desperfectos to "rlukaku" as "root";
grant select on "root".imagenes_desperfectos to "sfernandez" as "root";
grant update(ruta_imagen) on "root".imagenes_desperfectos to "sfernandez" as "root";
grant insert on "root".imagenes_desperfectos to "sfernandez" as "root";
...
grant select on "root".ingreso_vehiculos to "pfuentes" as "root";
grant update on "root".ingreso_vehiculos to "pfuentes" as "root";
grant insert on "root".ingreso_vehiculos to "pfuentes" as "root";
grant delete on "root".ingreso_vehiculos to "pfuentes" as "root";
grant select on "root".ingreso_vehiculos to "pmartinez" as "root";
grant update on "root".ingreso_vehiculos to "pmartinez" as "root";
grant insert on "root".ingreso_vehiculos to "pmartinez" as "root";
grant delete on "root".ingreso_vehiculos to "pmartinez" as "root";
...
grant select on "root".asignacion_ubicaciones_vehiculos to "mdiaz" as "root";
grant update(activo) on "root".asignacion_ubicaciones_vehiculos to "mdiaz" as "root";
grant insert on "root".asignacion_ubicaciones_vehiculos to "mdiaz" as "root";
...
grant select on "root".asignacion_ubicaciones_vehiculos to "pfuentes" as "root";
grant update(activo) on "root".asignacion_ubicaciones_vehiculos to "pfuentes" as "root";
grant insert on "root".asignacion_ubicaciones_vehiculos to "pfuentes" as "root";
grant select on "root".asignacion_ubicaciones_vehiculos to "pmartinez" as "root";
grant update(activo) on "root".asignacion_ubicaciones_vehiculos to "pmartinez" as "root";
grant insert on "root".asignacion_ubicaciones_vehiculos to "pmartinez" as "root";
...
grant select on "root".transporte_lotes to "edora" as "root";
grant update(fecha_hora_llegada) on "root".transporte_lotes to "edora" as "root";
grant insert on "root".transporte_lotes to "edora" as "root";
grant select on "root".transporte_lotes to "pfuentes" as "root";
grant update(fecha_hora_llegada) on "root".transporte_lotes to "pfuentes" as "root";
grant insert on "root".transporte_lotes to "pfuentes" as "root";
grant select on "root".transporte_lotes to "pmartinez" as "root";
grant update(fecha_hora_llegada) on "root".transporte_lotes to "pmartinez" as "root";
grant insert on "root".transporte_lotes to "pmartinez" as "root";
...
grant select on "root".vehiculos_lote to "erisas" as "root";
grant insert on "root".vehiculos_lote to "erisas" as "root";
grant delete on "root".vehiculos_lote to "erisas" as "root";
grant select on "root".vehiculos_lote to "mdiaz" as "root";
grant update on "root".vehiculos_lote to "mdiaz" as "root";
...
grant select on "root".vehiculos_lote to "pfuentes" as "root";
grant insert on "root".vehiculos_lote to "pfuentes" as "root";
grant delete on "root".vehiculos_lote to "pfuentes" as "root";
grant select on "root".vehiculos_lote to "pmartinez" as "root";
grant insert on "root".vehiculos_lote to "pmartinez" as "root";
grant delete on "root".vehiculos_lote to "pmartinez" as "root";
...
grant select on "root".vehiculos_lote to "rlukaku" as "root";
grant insert on "root".vehiculos_lote to "rlukaku" as "root";
grant delete on "root".vehiculos_lote to "rlukaku" as "root";
grant select on "root".vehiculos_lote to "sfernandez" as "root";
grant insert on "root".vehiculos_lote to "sfernandez" as "root";
grant delete on "root".vehiculos_lote to "sfernandez" as "root";
...
grant select on "root".telefonos_usuarios to "pfuentes" as "root";
grant update(telefono_particular) on "root".telefonos_usuarios to "pfuentes" as "root";
grant update(telefono_domicilio) on "root".telefonos_usuarios to "pfuentes" as "root";
grant insert on "root".telefonos_usuarios to "pfuentes" as "root";
grant delete on "root".telefonos_usuarios to "pfuentes" as "root";
grant select on "root".telefonos_usuarios to "pmartinez" as "root";
grant update(telefono_particular) on "root".telefonos_usuarios to "pmartinez" as "root";
grant update(telefono_domicilio) on "root".telefonos_usuarios to "pmartinez" as "root";
grant insert on "root".telefonos_usuarios to "pmartinez" as "root";
grant delete on "root".telefonos_usuarios to "pmartinez" as "root";
