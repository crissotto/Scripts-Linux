...
clear
    ...
    echo "|----------------------------------|"
	echo "1)Generar Backup de respaldo diferencial de directorio SYSCONFIG"
	...
	tar -cpvzf sysconfig_$fecha.tgz -N /home/admin/BACKUP/backupsysconfigtotal/respaldo_sysconfig_total.tgz /etc/sysconfig
	sleep 3s
    	clear
