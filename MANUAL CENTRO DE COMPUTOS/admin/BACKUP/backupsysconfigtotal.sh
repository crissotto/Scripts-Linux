clear
	...
	echo "" 
	echo "El respaldo se encontrara en la ruta /home/admin/BACKUP/backupsysconfigdiferencial"
	echo ""
    ...
    scp -r /home/"$user"/BACKUP/backupsysconfigdiferencial "$userdestino"@"$ipdestino":/home/"$userdestino"/BACKUP/backupsysconfigdiferencial
