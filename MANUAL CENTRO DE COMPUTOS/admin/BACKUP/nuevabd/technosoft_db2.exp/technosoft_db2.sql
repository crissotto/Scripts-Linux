...
grant connect to "gbergessio";
grant connect to "mmario";
...
{ unload file name = usuar00102.unl number of rows = 21 }
...
grant select on "root".roles_usuario to "apineyro" as "root";
grant select on "root".roles_usuario to "crissotto" as "root";
grant select on "root".roles_usuario to "dblanco" as "root";
grant select on "root".roles_usuario to "gbergessio" as "root";
grant select on "root".roles_usuario to "mmario" as "root";
...
grant select on "root".roles_usuario to "smorales" as "root";
grant select on "root".roles_usuario to "transportista" as "root";
grant select on "root".estados_usuario to "administrador" as "root";
grant select on "root".estados_usuario to "apineyro" as "root";
grant select on "root".estados_usuario to "crissotto" as "root";
grant select on "root".estados_usuario to "dblanco" as "root";
grant select on "root".estados_usuario to "gbergessio" as "root";
grant select on "root".estados_usuario to "mmario" as "root";
...
grant select on "root".usuarios to "apineyro" as "root";
grant update(estado_usuario) on "root".usuarios to "apineyro" as "root";
grant update(conectado) on "root".usuarios to "apineyro" as "root";
grant update(ultima_conexion) on "root".usuarios to "apineyro" as "root";
grant select on "root".usuarios to "crissotto" as "root";
grant update(estado_usuario) on "root".usuarios to "crissotto" as "root";
grant update(conectado) on "root".usuarios to "crissotto" as "root";
grant update(ultima_conexion) on "root".usuarios to "crissotto" as "root";
grant select on "root".usuarios to "dblanco" as "root";
grant update(estado_usuario) on "root".usuarios to "dblanco" as "root";
grant update(conectado) on "root".usuarios to "dblanco" as "root";
grant update(ultima_conexion) on "root".usuarios to "dblanco" as "root";
grant select on "root".usuarios to "gbergessio" as "root";
grant update(estado_usuario) on "root".usuarios to "gbergessio" as "root";
grant update(conectado) on "root".usuarios to "gbergessio" as "root";
grant update(ultima_conexion) on "root".usuarios to "gbergessio" as "root";
grant select on "root".usuarios to "mmario" as "root";
grant update(estado_usuario) on "root".usuarios to "mmario" as "root";
grant update(conectado) on "root".usuarios to "mmario" as "root";
grant update(ultima_conexion) on "root".usuarios to "mmario" as "root";
...
grant select on "root".usuarios to "smorales" as "root";
grant update(nombre) on "root".usuarios to "smorales" as "root";
grant update(apellido) on "root".usuarios to "smorales" as "root";
grant update(contrasena) on "root".usuarios to "smorales" as "root";
grant update(eliminado) on "root".usuarios to "smorales" as "root";
grant update(estado_usuario) on "root".usuarios to "smorales" as "root";
grant update(rol_usuario) on "root".usuarios to "smorales" as "root";
grant update(conectado) on "root".usuarios to "smorales" as "root";
grant update(ultima_conexion) on "root".usuarios to "smorales" as "root";
grant insert on "root".usuarios to "smorales" as "root";
grant delete on "root".usuarios to "smorales" as "root";
...
grant select on "root".estados_lote to "apineyro" as "root";
grant select on "root".estados_lote to "crissotto" as "root";
grant select on "root".estados_lote to "gbergessio" as "root";
grant select on "root".estados_lote to "mmario" as "root";
grant select on "root".estados_lote to "operario_puerto" as "root";
grant select on "root".estados_lote to "smorales" as "root";
...
grant select on "root".lotes to "apineyro" as "root";
grant update(asignado) on "root".lotes to "apineyro" as "root";
grant update(estado_lote) on "root".lotes to "apineyro" as "root";
grant select on "root".lotes to "crissotto" as "root";
grant update(nombre_lote) on "root".lotes to "crissotto" as "root";
grant update(tipo_vehiculos) on "root".lotes to "crissotto" as "root";
grant update(cantidad_vehiculos) on "root".lotes to "crissotto" as "root";
grant update(descripcion) on "root".lotes to "crissotto" as "root";
grant update(estado_lote) on "root".lotes to "crissotto" as "root";
grant update(eliminado) on "root".lotes to "crissotto" as "root";
grant insert on "root".lotes to "crissotto" as "root";
grant select on "root".lotes to "gbergessio" as "root";
grant update(asignado) on "root".lotes to "gbergessio" as "root";
grant update(estado_lote) on "root".lotes to "gbergessio" as "root";
grant select on "root".lotes to "mmario" as "root";
grant update(nombre_lote) on "root".lotes to "mmario" as "root";
grant update(tipo_vehiculos) on "root".lotes to "mmario" as "root";
grant update(cantidad_vehiculos) on "root".lotes to "mmario" as "root";
grant update(descripcion) on "root".lotes to "mmario" as "root";
grant update(estado_lote) on "root".lotes to "mmario" as "root";
grant update(eliminado) on "root".lotes to "mmario" as "root";
grant insert on "root".lotes to "mmario" as "root";
...
grant select on "root".lotes to "smorales" as "root";
grant update(nombre_lote) on "root".lotes to "smorales" as "root";
grant update(tipo_vehiculos) on "root".lotes to "smorales" as "root";
grant update(cantidad_vehiculos) on "root".lotes to "smorales" as "root";
grant update(descripcion) on "root".lotes to "smorales" as "root";
grant update(estado_lote) on "root".lotes to "smorales" as "root";
grant update(eliminado) on "root".lotes to "smorales" as "root";
grant insert on "root".lotes to "smorales" as "root";
...
grant select on "root".estados_vehiculo to "apineyro" as "root";
grant select on "root".estados_vehiculo to "crissotto" as "root";
grant select on "root".estados_vehiculo to "dblanco" as "root";
grant select on "root".estados_vehiculo to "gbergessio" as "root";
grant select on "root".estados_vehiculo to "mmario" as "root";
...
grant select on "root".estados_vehiculo to "smorales" as "root";
...
grant select on "root".tipos_vehiculo to "apineyro" as "root";
grant select on "root".tipos_vehiculo to "crissotto" as "root";
grant select on "root".tipos_vehiculo to "dblanco" as "root";
grant select on "root".tipos_vehiculo to "gbergessio" as "root";
grant select on "root".tipos_vehiculo to "mmario" as "root";
...
grant select on "root".tipos_vehiculo to "smorales" as "root";
...
grant select on "root".vehiculos to "apineyro" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "apineyro" as "root";
grant select on "root".vehiculos to "crissotto" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "crissotto" as "root";
grant update(codigo_qr) on "root".vehiculos to "crissotto" as "root";
grant select on "root".vehiculos to "dblanco" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "dblanco" as "root";
grant update(baja) on "root".vehiculos to "dblanco" as "root";
grant select on "root".vehiculos to "gbergessio" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "gbergessio" as "root";
grant select on "root".vehiculos to "mmario" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "mmario" as "root";
grant update(codigo_qr) on "root".vehiculos to "mmario" as "root";
...
grant select on "root".vehiculos to "smorales" as "root";
grant update(marca) on "root".vehiculos to "smorales" as "root";
grant update(modelo) on "root".vehiculos to "smorales" as "root";
grant update(tipo_vehiculo) on "root".vehiculos to "smorales" as "root";
grant update(anualidad) on "root".vehiculos to "smorales" as "root";
grant update(color) on "root".vehiculos to "smorales" as "root";
grant update(estado_vehiculo) on "root".vehiculos to "smorales" as "root";
grant update(codigo_qr) on "root".vehiculos to "smorales" as "root";
grant update(baja) on "root".vehiculos to "smorales" as "root";
grant update(eliminado) on "root".vehiculos to "smorales" as "root";
grant insert on "root".vehiculos to "smorales" as "root";
grant delete on "root".vehiculos to "smorales" as "root";
...
grant select on "root".tipos_ubicaciones to "dblanco" as "root";
grant select on "root".tipos_ubicaciones to "operario_patio" as "root";
grant select on "root".tipos_ubicaciones to "smorales" as "root";
...
grant select on "root".ubicaciones to "dblanco" as "root";
grant update(cantidad_vehiculos_actual) on "root".ubicaciones to "dblanco" as "root";
...
grant select on "root".ubicaciones to "smorales" as "root";
grant update(nombre_ubicacion) on "root".ubicaciones to "smorales" as "root";
grant update(capacidad_maxima) on "root".ubicaciones to "smorales" as "root";
grant update(cantidad_vehiculos_actual) on "root".ubicaciones to "smorales" as "root";
grant update(tipo_ubicacion) on "root".ubicaciones to "smorales" as "root";
grant insert on "root".ubicaciones to "smorales" as "root";
grant delete on "root".ubicaciones to "smorales" as "root";
...
grant select on "root".inspecciones to "crissotto" as "root";
grant update(incidente_vehiculo) on "root".inspecciones to "crissotto" as "root";
grant insert on "root".inspecciones to "crissotto" as "root";
grant select on "root".inspecciones to "dblanco" as "root";
grant update(incidente_vehiculo) on "root".inspecciones to "dblanco" as "root";
grant insert on "root".inspecciones to "dblanco" as "root";
grant select on "root".inspecciones to "mmario" as "root";
grant update(incidente_vehiculo) on "root".inspecciones to "mmario" as "root";
grant insert on "root".inspecciones to "mmario" as "root";
...
grant select on "root".inspecciones to "smorales" as "root";
grant update(incidente_vehiculo) on "root".inspecciones to "smorales" as "root";
grant insert on "root".inspecciones to "smorales" as "root";
...
grant select on "root".desperfectos_vehiculos to "crissotto" as "root";
grant update(observacion) on "root".desperfectos_vehiculos to "crissotto" as "root";
grant insert on "root".desperfectos_vehiculos to "crissotto" as "root";
grant select on "root".desperfectos_vehiculos to "dblanco" as "root";
grant update(observacion) on "root".desperfectos_vehiculos to "dblanco" as "root";
grant insert on "root".desperfectos_vehiculos to "dblanco" as "root";
grant select on "root".desperfectos_vehiculos to "mmario" as "root";
grant update(observacion) on "root".desperfectos_vehiculos to "mmario" as "root";
grant insert on "root".desperfectos_vehiculos to "mmario" as "root";
...
grant select on "root".desperfectos_vehiculos to "smorales" as "root";
grant update(observacion) on "root".desperfectos_vehiculos to "smorales" as "root";
grant insert on "root".desperfectos_vehiculos to "smorales" as "root";
...
grant select on "root".imagenes_desperfectos to "crissotto" as "root";
grant update(ruta_imagen) on "root".imagenes_desperfectos to "crissotto" as "root";
grant insert on "root".imagenes_desperfectos to "crissotto" as "root";
grant select on "root".imagenes_desperfectos to "dblanco" as "root";
grant update(ruta_imagen) on "root".imagenes_desperfectos to "dblanco" as "root";
grant insert on "root".imagenes_desperfectos to "dblanco" as "root";
grant select on "root".imagenes_desperfectos to "mmario" as "root";
grant update(ruta_imagen) on "root".imagenes_desperfectos to "mmario" as "root";
grant insert on "root".imagenes_desperfectos to "mmario" as "root";
...
grant select on "root".imagenes_desperfectos to "smorales" as "root";
grant update(ruta_imagen) on "root".imagenes_desperfectos to "smorales" as "root";
grant insert on "root".imagenes_desperfectos to "smorales" as "root";
...
grant select on "root".ingreso_vehiculos to "smorales" as "root";
grant update on "root".ingreso_vehiculos to "smorales" as "root";
grant insert on "root".ingreso_vehiculos to "smorales" as "root";
grant delete on "root".ingreso_vehiculos to "smorales" as "root";
...
grant select on "root".asignacion_ubicaciones_vehiculos to "dblanco" as "root";
grant update(activo) on "root".asignacion_ubicaciones_vehiculos to "dblanco" as "root";
grant insert on "root".asignacion_ubicaciones_vehiculos to "dblanco" as "root";
...
grant select on "root".asignacion_ubicaciones_vehiculos to "smorales" as "root";
grant update(activo) on "root".asignacion_ubicaciones_vehiculos to "smorales" as "root";
grant insert on "root".asignacion_ubicaciones_vehiculos to "smorales" as "root";
...
grant select on "root".transporte_lotes to "apineyro" as "root";
grant update(fecha_hora_llegada) on "root".transporte_lotes to "apineyro" as "root";
grant insert on "root".transporte_lotes to "apineyro" as "root";
grant select on "root".transporte_lotes to "gbergessio" as "root";
grant update(fecha_hora_llegada) on "root".transporte_lotes to "gbergessio" as "root";
grant insert on "root".transporte_lotes to "gbergessio" as "root";
grant select on "root".transporte_lotes to "smorales" as "root";
grant update(fecha_hora_llegada) on "root".transporte_lotes to "smorales" as "root";
grant insert on "root".transporte_lotes to "smorales" as "root";
...
grant select on "root".vehiculos_lote to "crissotto" as "root";
grant insert on "root".vehiculos_lote to "crissotto" as "root";
grant delete on "root".vehiculos_lote to "crissotto" as "root";
grant select on "root".vehiculos_lote to "dblanco" as "root";
grant update on "root".vehiculos_lote to "dblanco" as "root";
grant select on "root".vehiculos_lote to "mmario" as "root";
grant insert on "root".vehiculos_lote to "mmario" as "root";
grant delete on "root".vehiculos_lote to "mmario" as "root";
...
grant select on "root".vehiculos_lote to "smorales" as "root";
grant insert on "root".vehiculos_lote to "smorales" as "root";
grant delete on "root".vehiculos_lote to "smorales" as "root";
...
grant select on "root".telefonos_usuarios to "smorales" as "root";
grant update(telefono_particular) on "root".telefonos_usuarios to "smorales" as "root";
grant update(telefono_domicilio) on "root".telefonos_usuarios to "smorales" as "root";
grant insert on "root".telefonos_usuarios to "smorales" as "root";
grant delete on "root".telefonos_usuarios to "smorales" as "root";
