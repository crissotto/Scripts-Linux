...
clear
    ...
    echo "|----------------------------------|"
	echo "1)Generar Backup de la Base de Datos TOTAL"
	...
	sleep 3s
	cd /home/admin/BACKUP/backupbdtotal
	dbexport -d technosoft_db2
	tar -cpvzf technosoftdb_2_total.tgz ./technosoft_db2.exp
	sleep 3s
    	clear
	echo "Su respaldo ha sido satisfactorio!"
	echo "" 
	echo "El respaldo se encontrara en la ruta /home/admin/BACKUP/backupbdtotal"
	echo ""
	...
	2)user=$(cat user.txt)
  	  userdestino=$(cat /home/$user/BACKUP/userdestino.txt)
    	  ...
    	  cd /home/$user/BACKUP/backupbdtotal

    scp -r /home/"$user"/BACKUP/backupbdtotal "$userdestino"@"$ipdestino":/home/"$userdestino"/backupbdtotal
